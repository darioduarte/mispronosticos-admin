...
type Props = {
  progress: PreMatchRangeProgressState;
  desde: string;
  hasta: string;
  onlyMissing: boolean;
  pauseMs: number;
  ...
  return (
    ...
    >
      <div
        ...
        role="dialog"
        aria-labelledby="prematch-range-title"
        aria-busy={busy}
      >
        <div className="border-b border-white/10 px-5 py-4">
          <div className="flex flex-wrap items-center gap-2">
            <h2 id="prematch-range-title" className="text-lg font-semibold text-white">
              Generando análisis IA prepartido
            </h2>
...
function PhaseBadge({
  ...
  phase: PreMatchRangeProgressState['phase'];
  isPausing?: boolean;
}) {
